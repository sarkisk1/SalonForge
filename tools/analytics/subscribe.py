#!/usr/bin/env python3
"""Weekly email of the 'Website — Traffic & Leads' dashboard (idempotent by title + recipient)."""
...
title = "Daviana website — weekly summary"
body = {"dashboard": dash["id"], "dashboard_export_insights": [ids[n] for n in PICK], "target_type": "email", "target_value": EMAIL,
        "frequency": "weekly", "interval": 1, "byweekday": ["monday"], "start_date": "2026-09-28T07:00:00Z", "title": title}
